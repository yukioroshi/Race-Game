...
#include "Race_GameOffroadCar.h"
#include "Race_GameOffroadWheelFront.h"
#include "Race_GameOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ARace_GameOffroadCar::ARace_GameOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URace_GameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URace_GameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URace_GameOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URace_GameOffroadWheelRear::StaticClass();
