...
#include "Race_GameSportsCar.h"
#include "Race_GameSportsWheelFront.h"
#include "Race_GameSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ARace_GameSportsCar::ARace_GameSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URace_GameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URace_GameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URace_GameSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URace_GameSportsWheelRear::StaticClass();
